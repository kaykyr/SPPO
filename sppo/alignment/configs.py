    ...
    def parse_yaml_and_args(self, yaml_arg: str, other_args: Optional[List[str]] = None) -> List[dataclass]:
        ...
        for arg in other_args:
            if "=" in arg:
                ...
                processed_args[key.strip("-")] = value
            else:
                key = arg.strip("-")
        ...
        for data_yaml, data_class in zip(arg_list, self.dataclass_types):
            ...
            for arg, val in processed_args.items():
                if arg in keys:
        ...
        # Verificando se ambos fp16 e bf16 estão configurados como True
        for obj in outputs:
            if hasattr(obj, 'fp16') and hasattr(obj, 'bf16'):
